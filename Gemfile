...
#Bulma is used for styling. It's similar to bootstrap
...
#helps to create much simpler, powerful and stylish forms
gem 'simple_form'
...
group :test do
  ...
  #aims to mimic the behaviour of a real user, and as such interacts with the HTML of the application.
